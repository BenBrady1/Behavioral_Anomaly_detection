...
N_ANOMALIES = 75              # injected anomalies across all users
...
def inject_anomalies(events, user_home_cities):
    ...
    anomaly_types = {
        "impossible_travel": int(N_ANOMALIES * 0.40),
        "typing_speed":      int(N_ANOMALIES * 0.25),
        "click_through":     int(N_ANOMALIES * 0.20),
